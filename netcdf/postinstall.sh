...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lhdf5_hl -lhdf5 -ldl -lm -lz " CFLAGS="-I/root/edge/netcdf/../libs/include" LDFLAGS="-L/root/edge/netcdf/../libs/lib" ./configure --prefix=/root/edge/netcdf/../libs $STATIC_BUILD $SHARED_BUILD
