...
#define MOAB_CONFIGURE_COMMAND "./configure  '--disable-debug' '--enable-optimize' '--enable-shared=no' '--enable-static=yes' '--with-mpi' '--disable-fortran' '--enable-tools' '--enable-all-static' '--with-hdf5=/root/edge/submodules/moab/../../libs' '--with-netcdf=/root/edge/submodules/moab/../../libs' '--with-zlib=/root/edge/submodules/moab/../../libs' '--with-pnetcdf=no' '--prefix=/root/edge/submodules/moab/../../libs' 'CC=mpicc' 'CXX=mpiCC' 'F77=mpiifort' 'FC=mpiifort'"
#endif

/* Configuration information. */
#ifndef MOAB_CONFIGURE_INFO
#define MOAB_CONFIGURE_INFO "./configure run on Fri Aug  3 20:36:54 UTC 2018"
#endif
...
#define MOAB_HAVE_HDF5_PARALLEL 1
#endif
...
#ifndef MOAB_HAVE_MBCOUPLER
#define MOAB_HAVE_MBCOUPLER 1
#endif
...
#ifndef MOAB_HAVE_MCNPMIT
#define MOAB_HAVE_MCNPMIT 1
#endif
...
#define MOAB_HAVE_NETCDF 1
#endif

/* Define to 1 if you have the <netcdf.h> header file. */
#ifndef MOAB_HAVE_NETCDF_H
#define MOAB_HAVE_NETCDF_H 1
#endif
...
#ifndef MOAB_HAVE_REFINER
#define MOAB_HAVE_REFINER 1
#endif
...
#define MOAB_PACKAGE_STRING "MOAB 4.9.3pre"
#endif
...
#define MOAB_PACKAGE_VERSION "4.9.3pre"
#endif
...
#define MOAB_VERSION_PATCH 3pre
#endif

/* MOAB Version String */
#ifndef MOAB_VERSION_STRING
#define MOAB_VERSION_STRING "MOAB 4.9.3pre"
#endif
